<h3>Sản phẩm mới nhất</h3>
               <ul class="product_list" >
                <li>
                    ...
                    <p class="title_product" >Tên sản phẩm: Váy trắng trễ vai nữ tiểu thư </p>
                ...
                <li>
                    ...
                    <p class="title_product" >Tên sản phẩm: Đầm váy nữ cổ tròn tay bồng đính đá </p>
                ...
                <li>
                    ...
                    <p class="title_product" >Tên sản phẩm: Đầm váy nữ dáng xòe phối voan </p>
