 ...
 ?>
  <tr>
    ...
    <td>
      ...
      <a href="../pages/main/themgiohang.php?tru=<?php echo $cart_item['id'] ?>"><i class="fa-solid fa-minus fa-2xs fa-style "></i></a>
      <?php echo $cart_item['soluong']; ?>
      <!-- <a href="../pages/main/themgiohang.php?tru=<?php echo $cart_item['id'] ?>">Trừ</a> -->
      <a href="../pages/main/themgiohang.php?cong=<?php echo $cart_item['id'] ?>"><i class="fa-solid fa-plus fa-2xs fa-style"></i></a>
